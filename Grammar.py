    ...
    def match(self, ch, fabian):
        ...
        if ch == 'I5' and self.goal_list[self.p][1] == 'return':  # return 语句
            if self.return_type == 'void':
                self.warnings_str+="Warning: 第%s行 return语句错误，函数没有返回值！\n" % (self.goal_list[self.p][0])
            self.return_flag = 1
        # print(self.goal_list[self.p][1], '----', ch)
            ...
            if self.goal_list[self.p][1] in first_dict[ch][i] or self.goal_list[self.p][2] in first_dict[ch][i]:
                ...
                for item in rule:
                    ...
                    if ch == 'A5':  # 函数定义
                        if item == 'A6':  # 函数类型
                            ...
                            self.return_type = function_type # 函数返回类型 void int ...
                    ...
                    if item in self.vn:
                        ...
                        if item == 'main': #
                            self.return_type = 'int' # main返回类型为int
                ...
                if ch == 'A5':  # 函数定义
                    ...
                    if self.return_flag != 1:
                        ...
                        self.count += 1
                        if self.return_type != 'void':
                            self.warnings_str+="Warning: 第%s行 函数没有返回值!\n" % (self.goal_list[self.p][0])
                    self.return_flag = 0
                if ch == 'I5':  # return 语句
                    if not self.if_match_format(self.return_type,self.expression_list.gettop()[0]):
                        self.warnings_str+="Warning: 第%s行 return语句返回类型不匹配!\n" % (self.goal_list[self.p][0])
...
# a.solve([[2, 'const', '105'], [2, 'int', '102'], [2, 'e', '700'], [2, '=', '230'], [2, '1', '400'], [2, ';', '303'], [3, 'const', '105'], [3, 'int', '102'], [3, 'f', '700'], [3, '=', '230'], [3, '2', '400'], [3, ',', '304'], [3, 'g', '700'], [3, '=', '230'], [3, '3', '400'], [3, ';', '303'], [4, 'int', '102'], [4, 'a', '700'], [4, '=', '230'], [4, '1', '400'], [4, ';', '303'], [5, 'char', '101'], [5, 'b', '700'], [5, '=', '230'], [5, "'b'", '500'], [5, ';', '303'], [6, 'char', '101'], [6, 'm', '700'], [6, '=', '230'], [6, "'n'", '500'], [6, ',', '304'], [6, 'n', '700'], [6, '=', '230'], [6, "'m'", '500'], [6, ';', '303'], [7, 'string', '135'], [7, 'c', '700'], [7, '=', '230'], [7, '"acc"', '600'], [7, ';', '303'], [8, 'bool', '136'], [8, 'd', '700'], [8, '=', '230'], [8, 'true', '137'], [8, ';', '303'], [11, 'int', '102'], [11, 'sum', '700'], [11, '(', '201'], [11, 'int', '102'], [11, ',', '304'], [11, 'int', '102'], [11, ')', '202'], [11, ';', '303'], [13, 'main', '142'], [13, '(', '201'], [13, ')', '202'], [13, '{', '301'], [15, 'f', '700'], [15, '=', '230'], [15, '4', '400'], [15, ';', '303'], [16, 'm', '700'], [16, '=', '230'], [16, 'c', '700'], [16, '+', '207'], [16, '1', '400'], [16, ';', '303'], [17, 'int', '102'], [17, 'N', '700'], [17, '=', '230'], [17, 'read', '700'], [17, '(', '201'], [17, ')', '202'], [17, ';', '303'], [18, 'b', '700'], [18, '=', '230'], [18, '1', '400'], [18, '+', '207'], [18, 'N', '700'], [18, '+', '207'], [18, 'c', '700'], [18, ';', '303'], [19, 'a', '700'], [19, '=', '230'], [19, 'sum', '700'], [19, '(', '201'], [19, 'sum', '700'], [19, '(', '201'], [19, '3', '400'], [19, ',', '304'], [19, 'd', '700'], [19, ')', '202'], [19, ',', '304'], [19, 'N', '700'], [19, ')', '202'], [19, ';', '303'], [20, 'write', '700'], [20, '(', '201'], [20, 'a', '700'], [20, ')', '202'], [20, ';', '303'], [22, '}', '302'], [24, 'int', '102'], [24, 'sum', '700'], [24, '(', '201'], [24, 'int', '102'], [24, 'sum_x', '700'], [24, ',', '304'], [24, 'int', '102'], [24, 'sum_y', '700'], [24, ')', '202'], [24, '{', '301'], [26, 'int', '102'], [26, 'result', '700'], [26, ';', '303'], [27, 'result', '700'], [27, '=', '230'], [27, 'sum_x', '700'], [27, '+', '207'], [27, 'sum_y', '700'], [27, '+', '207'], [27, 'z', '700'], [27, ';', '303'], [29, 'return', '106'], [29, 'result', '700'], [29, ';', '303'], [31, '}', '302']]
# )
# a.solve([[2, 'int', '102'], [2, 'a', '700'], [2, '=', '230'], [2, '1', '400'], [2, ';', '303'], [3, 'char', '101'], [3, 'b', '700'], [3, '=', '230'], [3, "'b'", '500'], [3, ';', '303'], [4, 'string', '135'], [4, 'c', '700'], [4, '=', '230'], [4, '"acc"', '600'], [4, ';', '303'], [5, 'bool', '136'], [5, 'd', '700'], [5, '=', '230'], [5, 'true', '137'], [5, ';', '303'], [6, 'int', '102'], [6, 'sum', '700'], [6, '(', '201'], [6, 'int', '102'], [6, ',', '304'], [6, 'int', '102'], [6, ')', '202'], [6, ';', '303'], [8, 'main', '142'], [8, '(', '201'], [8, ')', '202'], [8, '{', '301'], [10, 'int', '102'], [10, 'N', '700'], [10, '=', '230'], [10, 'read', '700'], [10, '(', '201'], [10, ')', '202'], [10, ';', '303'], [11, 'b', '700'], [11, '=', '230'], [11, '1', '400'], [11, '+', '207'], [11, 'N', '700'], [11, '+', '207'], [11, 'c', '700'], [11, ';', '303'], [12, 'a', '700'], [12, '=', '230'], [12, 'sum', '700'], [12, '(', '201'], [12, 'sum', '700'], [12, '(', '201'], [12, '3', '400'], [12, ',', '304'], [12, 'd', '700'], [12, ')', '202'], [12, ',', '304'], [12, 'N', '700'], [12, ')', '202'], [12, ';', '303'], [13, 'write', '700'], [13, '(', '201'], [13, 'a', '700'], [13, ')', '202'], [13, ';', '303'], [15, '}', '302'], [17, 'int', '102'], [17, 'sum', '700'], [17, '(', '201'], [17, 'int', '102'], [17, 'sum_x', '700'], [17, ',', '304'], [17, 'int', '102'], [17, 'sum_y', '700'], [17, ')', '202'], [17, '{', '301'], [19, 'int', '102'], [19, 'result', '700'], [19, ';', '303'], [20, 'result', '700'], [20, '=', '230'], [20, 'sum_x', '700'], [20, '+', '207'], [20, 'sum_y', '700'], [20, '+', '207'], [20, 'z', '700'], [20, ';', '303'], [22, 'return', '106'], [22, 'result', '700'], [22, ';', '303'], [24, '}', '302']]
# )
# a.solve([[2, 'int', '102'], [2, 'a', '700'], [2, '=', '230'], [2, '1', '400'], [2, ';', '303'], [3, 'char', '101'], [3, 'b', '700'], [3, '=', '230'], [3, "'b'", '500'], [3, ';', '303'], [4, 'string', '135'], [4, 'c', '700'], [4, '=', '230'], [4, '"acc"', '600'], [4, ';', '303'], [5, 'bool', '136'], [5, 'd', '700'], [5, '=', '230'], [5, 'true', '137'], [5, ';', '303'], [6, 'int', '102'], [6, 'sum', '700'], [6, '(', '201'], [6, 'int', '102'], [6, ',', '304'], [6, 'int', '102'], [6, ')', '202'], [6, ';', '303'], [8, 'main', '142'], [8, '(', '201'], [8, ')', '202'], [8, '{', '301'], [10, 'int', '102'], [10, 'N', '700'], [10, '=', '230'], [10, 'read', '700'], [10, '(', '201'], [10, ')', '202'], [10, ';', '303'], [11, 'b', '700'], [11, '=', '230'], [11, '1', '400'], [11, '+', '207'], [11, 'N', '700'], [11, '+', '207'], [11, 'c', '700'], [11, ';', '303'], [12, 'a', '700'], [12, '=', '230'], [12, 'sum', '700'], [12, '(', '201'], [12, 'sum', '700'], [12, '(', '201'], [12, '3', '400'], [12, ',', '304'], [12, 'd', '700'], [12, ')', '202'], [12, ',', '304'], [12, 'N', '700'], [12, ')', '202'], [12, ';', '303'], [13, 'write', '700'], [13, '(', '201'], [13, 'a', '700'], [13, ')', '202'], [13, ';', '303'], [15, '}', '302'], [17, 'int', '102'], [17, 'sum', '700'], [17, '(', '201'], [17, 'int', '102'], [17, 'sum_x', '700'], [17, ',', '304'], [17, 'int', '102'], [17, 'sum_y', '700'], [17, ')', '202'], [17, '{', '301'], [19, 'int', '102'], [19, 'result', '700'], [19, ';', '303'], [20, 'result', '700'], [20, '=', '230'], [20, 'sum_x', '700'], [20, '+', '207'], [20, 'sum_y', '700'], [20, '+', '207'], [20, 'z', '700'], [20, ';', '303'], [22, 'return', '106'], [22, 'result', '700'], [22, ';', '303'], [24, '}', '302']])
